...
trait VictronConstants
{
    ...
    protected $variable_mapping = [
        ...
        "LOAD" => array('Name' => 'Load output state', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix'  => '', 'suffix' => '', 'min' => 0, 'max' => 1, 'steps' => ''), 'Divider' => 1, 'Value' => 0),
        ...
        "TTG" => array('Name' => 'Time-to-go', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => ' min', 'min' => 0, 'max' => 100, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        "Alarm" => array('Name' => 'Alarm condition active', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 1, 'steps' => '', 'values' => array('id' => false, 'values' => 'On', 'values' => 'Off')), 'Divider' => 1, 'Value' => 0),
        "Relay" => array('Name' => 'Relay state', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 1, 'steps' => ''), 'Divider' => 1, 'Value' => 0),
        "AR" => array('Name' => 'Alarm reason', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 8192, 'steps' => ''), 'Divider' => 1, 'Value' => 1),
        "OR" => array('Name' => 'Off reason', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 128, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        ...
        "ERR" => array('Name' => 'Error code', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 128, 'steps' => ''), 'Divider' => 1, 'Value' => 1),
        "CS" => array('Name' => 'State of operation', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 255, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        ...
        "MODE" => array('Name' => 'Device mode', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 16, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        ...
        "WARN" => array('Name' => 'Warning reason', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => '', 'steps' => ''), 'Divider' => 1, 'Value' => 1),
        "MPPT" => array('Name' => 'Tracker operation mode', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => false, 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 2, 'steps' => 1), 'Divider' => 1, 'Value' => 1)
    ];
