...
trait VictronConstants
{
    ...
    protected $variable_mapping = [
        ...
        "LOAD" => array('Name' => 'Load output state', 'custom_profile' => array('id' => 'Load output state', 'icon' => '', 'prefix'  => '', 'suffix' => '', 'min' => '', 'max' => 1, 'steps' => ''), 'Divider' => 1, 'Value' => FALSE),
        ...
        "Alarm" => array('Name' => 'Alarm condition active', 'custom_profile' => array('id' => 'Alarm condition active', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => 1, 'steps' => '', 'values' => array('values' => 'On', 'values' => 'Off')), 'Divider' => 1, 'Value' => FALSE),
        "Relay" => array('Name' => 'Relay state', 'custom_profile' => array('id' => 'Relay state', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => 1, 'steps' => ''), 'Divider' => 1, 'Value' => FALSE),
        "AR" => array('Name' => 'Alarm reason', 'custom_profile' => array('id' => 'Alarm reason', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => 8192, 'steps' => ''), 'Divider' => 1, 'Value' => 0),
        "OR" => array('Name' => 'Off reason', 'custom_profile' => array('id' => 'Off reason', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => 128, 'steps' => 1), 'Divider' => 1, 'Value' => 0),
        ...
        "ERR" => array('Name' => 'Error code', 'custom_profile' => array('id' => 'Error code', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => 128, 'steps' => ''), 'Divider' => 1, 'Value' => 0),
        "CS" => array('Name' => 'State of operation', 'custom_profile' => array('id' => 'State of operation', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => 255, 'steps' => 1), 'Divider' => 1, 'Value' => 0),
        ...
        "MODE" => array('Name' => 'Device mode', 'custom_profile' => array('id' => 'Device mode', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => 16, 'steps' => 1), 'Divider' => 1, 'Value' => 0),
        ...
        "WARN" => array('Name' => 'Warning reason', 'custom_profile' => array('id' => 'Warning reason', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => '', 'max' => '', 'steps' => ''), 'Divider' => 1, 'Value' => 0),
        "MPPT" => array('Name' => 'Tracker operation mode', 'custom_profile' => array('id' => 'Tracker operation mode', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 2, 'steps' => 1), 'Divider' => 1, 'Value' => 0)
    ];
