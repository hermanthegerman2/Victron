...
trait VictronConstants
{
    ...
    protected $variable_mapping = [
        ...
        "LOAD" => array('Name' => 'Load output state', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Load_output_state', 'icon' => '', 'prefix'  => '', 'suffix' => '', 'min' => 0, 'max' => 1, 'steps' => ''), 'Divider' => 1, 'Value' => 0),
        ...
        "TTG" => array('Name' => 'Time-to-go', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Time_to_go', 'icon' => '', 'prefix' => '', 'suffix' => ' min', 'min' => 0, 'max' => 100, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        "Alarm" => array('Name' => 'Alarm condition active', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Alarm_condition_active', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 1, 'steps' => '', 'values' => array('id' => 'Alarm_condition_active', 'values' => 'On', 'values' => 'Off')), 'Divider' => 1, 'Value' => 0),
        "Relay" => array('Name' => 'Relay state', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Relay_state', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 1, 'steps' => ''), 'Divider' => 1, 'Value' => 0),
        "AR" => array('Name' => 'Alarm reason', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Alarm_reason', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 8192, 'steps' => ''), 'Divider' => 1, 'Value' => 1),
        "OR" => array('Name' => 'Off reason', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Off_reason', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 128, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        ...
        "H19" => array('Name' => 'Yield total', 'icon' => 'EnergySolar', 'custom_profile' => '~Electricity', 'Divider' => 1, 'Value' => 2),
        "H20" => array('Name' => 'Yield today', 'icon' => 'EnergySolar', 'custom_profile' => '~Electricity', 'Divider' => 1, 'Value' => 2),
        "H21" => array('Name' => 'Maximum power today', 'icon' => 'EnergySolar', 'custom_profile' => '~Watt.3680', 'Divider' => 1, 'Value' => 2),
        "H22" => array('Name' => 'Yield yesterday', 'icon' => 'EnergySolar', 'custom_profile' => '~Electricity', 'Divider' => 1, 'Value' => 2),
        "H23" => array('Name' => 'Maximum power yesterday', 'icon' => 'EnergySolar', 'custom_profile' => '~Watt.3680', 'Divider' => 1, 'Value' => 2),
        "ERR" => array('Name' => 'Error code', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Error_code', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 128, 'steps' => ''), 'Divider' => 1, 'Value' => 1),
        "CS" => array('Name' => 'State of operation', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'State_of_operation', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 255, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        ...
        "MODE" => array('Name' => 'Device mode', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Device_mode', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 16, 'steps' => 1), 'Divider' => 1, 'Value' => 1),
        ...
        "WARN" => array('Name' => 'Warning reason', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Warning_reason', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => '', 'steps' => ''), 'Divider' => 1, 'Value' => 1),
        "MPPT" => array('Name' => 'Tracker operation mode', 'icon' => 'EnergySolar', 'custom_profile' => array('id' => 'Tracker_operation_mode', 'icon' => '', 'prefix' => '', 'suffix' => '', 'min' => 0, 'max' => 2, 'steps' => 1), 'Divider' => 1, 'Value' => 1)
    ];
